...
class GiftcodeWillExpireSoonEmail extends Mailable implements SettingableMail
{
    ...
    public function build()
    {
        ...
        $setting['body'] = str_replace('{{expiration_date}}',(is_null($this->giftcode->expiration_date)) ? 'Unknown' : $this->giftcode->expiration_date,$setting['body']);
    ...
    {
        try {
            return giftcodeGetEmailContent('GIFTCODE_WILL_EXPIRING_SOON_EMAIL');
