...
interface GiftcodeServiceInterface extends Grpc\ServiceInterface
{
    ...
    public const NAME = "giftcode.services.GiftcodeService";
    ...
    * @throws Grpc\Exception\InvokeException
    */
    public function getUserCreatedGiftcodesCount(Context $context, Services\User $request): Count;
    ...
    * @throws Grpc\Exception\InvokeException
    */
    public function getUserExpiredGiftcodesCount(Context $context, Services\User $request): Count;
    ...
    * @throws Grpc\Exception\InvokeException
    */
    public function getUserCanceledGiftcodesCount(Context $context, Services\User $request): Count;
    ...
    * @throws Grpc\Exception\InvokeException
    */
    public function getUserRedeemedGiftcodesCount(Context $context, Services\User $request): Count;
}
