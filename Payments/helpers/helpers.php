    ...
    'INVOICE_CRATED_EMAIL' => [
        ...
        'body' => <<<EOT
                ...
                <ol>
                    ...
                    <li>
                    <p>Here is the confirmation of the conversion rate of the due amount {{usd_amount}} to {{crypto}} at the moment of creating the invoice: <a href="https://blockchain.info/frombtc?value={{due_amount}}&currency=USD&time={{current_time}}&textual=true&nosavecurrency=true" target="_blank">Click Here</a></p>
                    </li>
                    <li>
